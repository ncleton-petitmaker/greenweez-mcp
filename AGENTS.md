...
| Carrefour Drive MCP | [GitHub](https://github.com/ncleton-petitmaker/carrefour-drive-mcp) · [checkout local](./carrefour-drive-mcp/README.md) | Serveur et CLI web Carrefour Drive adossés à un profil Camoufox isolé : onboarding, session, catalogue, fiches, panier et ajout confirmé avec réconciliation ; publication sur `main`, release `v0.2.0`. Aucun téléphone ni backend mobile. |
